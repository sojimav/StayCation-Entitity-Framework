...
GO
PRINT N'Dropping Default Constraint unnamed constraint on [dbo].[StayCationHomeTable]...';


GO
ALTER TABLE [dbo].[StayCationHomeTable] DROP CONSTRAINT [DF__StayCatio__Popul__25869641];


GO
PRINT N'Altering Table [dbo].[StayCationHomeTable]...';


GO
ALTER TABLE [dbo].[StayCationHomeTable] ALTER COLUMN [Group] VARCHAR (200) NOT NULL;

ALTER TABLE [dbo].[StayCationHomeTable] ALTER COLUMN [Image] VARCHAR (200) NOT NULL;

ALTER TABLE [dbo].[StayCationHomeTable] ALTER COLUMN [Location] VARCHAR (100) NOT NULL;

ALTER TABLE [dbo].[StayCationHomeTable] ALTER COLUMN [NameOfProp] VARCHAR (100) NOT NULL;

ALTER TABLE [dbo].[StayCationHomeTable] ALTER COLUMN [Popularity] VARCHAR (100) NULL;

ALTER TABLE [dbo].[StayCationHomeTable] ALTER COLUMN [Price] VARCHAR (50) NOT NULL;


GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[StayCationHomeTable]...';


GO
ALTER TABLE [dbo].[StayCationHomeTable]
    ADD DEFAULT NULL FOR [Popularity];
