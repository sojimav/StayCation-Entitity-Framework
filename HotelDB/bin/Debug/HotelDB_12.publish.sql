...
IF EXISTS (select top 1 1 from [dbo].[RegisterUserTable])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping Primary Key unnamed constraint on [dbo].[RegisterUserTable]...';


GO
ALTER TABLE [dbo].[RegisterUserTable] DROP CONSTRAINT [PK__Register__3214EC078409EADC];


GO
PRINT N'Altering Table [dbo].[RegisterUserTable]...';


GO
ALTER TABLE [dbo].[RegisterUserTable] DROP COLUMN [Id];


GO
PRINT N'Refreshing Procedure [dbo].[FetchUserDetails]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[FetchUserDetails]';


GO
PRINT N'Refreshing Procedure [dbo].[InsertUser]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[InsertUser]';
