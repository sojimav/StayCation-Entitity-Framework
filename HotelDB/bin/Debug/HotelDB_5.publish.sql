...
GO
PRINT N'Creating Procedure [dbo].[RegisteredUsersProcedure]...';
...
AS
	...
	END
GO
PRINT N'Creating Procedure [dbo].[StayCationHomeProcedure]...';


GO

CREATE PROCEDURE [dbo].[StayCationHomeProcedure]
	
	AS

	BEGIN

		SELECT * FROM StayCationHomeTable;
